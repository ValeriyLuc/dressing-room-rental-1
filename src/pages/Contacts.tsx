...
const contactInfo = [
  {
    icon: "MapPin",
    title: "Адрес",
    details: ["г. Москва, ул. Киностудийная, 42", "БЦ «Медиа Сити», 3 этаж"],
  },
  {
    icon: "Phone",
    title: "Телефоны",
                  ...
                  <CardContent className="p-0">
                    <div className="grid grid-cols-1 md:grid-cols-2 h-full">
                      <div className="bg-primary p-8 text-white">
                        ...
                        <p className="mb-6">
                          Заполните форму, и наш менеджер свяжется с вами в
                          ближайшее время для консультации или оформления заказа
                        </p>
                    ...
                    <div className="relative h-[500px] bg-gray-100">
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center">
                        ...
                        <p className="text-gray-500 max-w-md text-center">
                          Мы находимся по адресу: г. Москва, ул. Киностудийная,
                          42, БЦ «Медиа Сити», 3 этаж
                        </p>
                      </div>
                    </div>
                    <div className="p-6">
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <p className="text-gray-600">
                            От станции метро «Медиагородок» пешком 7 минут по
                            указателям до БЦ «Медиа Сити»
                          </p>
                        </div>
                        <div>
                          <p className="font-medium mb-1">На автомобиле:</p>
                          <p className="text-gray-600">
                            Удобный подъезд с Третьего транспортного кольца. Для
                            клиентов компании первые 3 часа парковки бесплатно.
                          </p>
                        </div>
                      </div>
                    </div>
        ...
        <div className="mt-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Наша команда всегда рада помочь с выбором оборудования или
              ответить на любые вопросы о наших услугах
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="border-0 shadow-sm text-center">
              <CardContent className="p-6 flex flex-col items-center">
                ...
                <p className="text-gray-600 mb-4">
                  По всем вопросам вы можете связаться с нами по телефону в
                  рабочее время
                </p>
                <div className="flex items-center">
            ...
            <Card className="border-0 shadow-sm text-center">
              <CardContent className="p-6 flex flex-col items-center">
                ...
                <p className="text-gray-600 mb-4">
                  Отправьте нам сообщение по электронной почте и получите ответ
                  в течение 30 минут
                </p>
                <div className="flex items-center">
                  <Icon name="Mail" className="h-5 w-5 text-gray-500 mr-3" />
                  <a
                    href="mailto:1223pleer@gmail.com"
                    className="text-gray-700 hover:text-primary"
                  >
                    1223pleer@gmail.com
                  </a>
            ...
            <Card className="border-0 shadow-sm text-center">
              <CardContent className="p-6 flex flex-col items-center">
                ...
                <p className="text-gray-600 mb-4">
                  Свяжитесь с нами через мессенджеры для быстрой консультации в
                  любое время
                </p>

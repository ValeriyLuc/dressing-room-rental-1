                ...
                <div>
                  <Badge className="mb-2">
                    {projectCategories.find(
                      (c) => c.id === projectDetails.category,
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Наш менеджер связывается с вами для уточнения деталей и
                требований
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Мы готовим все необходимое оборудование и мебель под ваши задачи
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Доставляем, монтируем и обеспечиваем техническую поддержку
              </p>
            </div>
          </div>
        </div>

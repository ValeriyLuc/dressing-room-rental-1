  ...
  return (
    <div className="relative overflow-hidden bg-gray-900">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: "url('https://images.unsplash.com/photo-1504507926119-51c48b77a052?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')",
          opacity: 0.5 
        }}
      >
        ...
        <div className="max-w-3xl">
          <div className="mb-6">
            ...
            <p className="text-xl text-gray-200 mb-8">
              Создайте идеальные условия для вашей съемочной площадки с нашим широким ассортиментом

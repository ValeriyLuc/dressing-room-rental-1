    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-primary text-white py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Каталог оборудования и мебели</h1>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 sticky top-24">
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="category-all" className="ml-2 text-gray-700 cursor-pointer">
                    Все категории
                  </label>
                </div>
          ...
          <div className="flex-grow">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
              ...
              <div className="flex items-center gap-2 w-full md:w-auto">
                <span className="text-gray-600 whitespace-nowrap">Сортировать по:</span>
            ...
            {sortedProducts.length > 0 ? (
              ...
              <div className="bg-gray-50 rounded-lg p-12 text-center">
                ...
                <p className="text-gray-600 mb-6">По вашему запросу ничего не найдено. Попробуйте изменить параметры поиска.</p>
                <Button onClick={() => {

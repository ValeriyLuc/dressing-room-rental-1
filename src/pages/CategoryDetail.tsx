...
const CategoryDetail = () => {
  ...
  > = {
    ...
    "makeup-tables": {
      ...
      additionalInfo:
        "Самый быстрый и экономичный способ решить проблему нехватки мебели для важного мероприятия — аренда. Получите больше, потратив меньше. Если вам не хватает стульев, столов или другой мебели для удобного размещения гостей, просто закажите недостающие позиции у нас. Почему именно мы?\n\nНаши преимущества:\n1. Мы предоставляем широкий ассортимент мебели для самых разных нужд.\n2. Вы всегда можете рассчитывать на подробные консультации — мы с удовольствием ответим на любые ваши вопросы.\n3. Доставка мебели осуществляется строго в установленное время.\n4. У нас представлены только самые выгодные условия аренды.\n5. Вы получите качественную и стильную мебель в необходимом количестве.",
    },
    furniture: {
    ...
    accessories: {
      full: "Аксессуары и дополнительное оборудование играют важную роль в создании комфортных и функциональных условиях для работы съемочной группы. В нашем ассортименте представлены различные типы аксессуаров – от вешалок для костюмов до зеркал, офисной техники и бытовых приборов. Эти элементы помогают организовать рабочий процесс и обеспечить необходимый комфорт для всех участников съемки.",
      specs: [
        {
          name: "Категории",

  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <Badge variant="secondary" className="mb-2">Портфолио</Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Реализованные проекты</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Примеры реальных съемочных площадок, оборудованных с использованием нашего оборудования
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden group">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-2">Съемочный павильон «Кинолайт»</h3>
                <p className="text-gray-600 mb-4">
                  Комплекс из 12 гримерных комнат для крупномасштабных съемок художественного фильма
                </p>
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden group">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-2">Телестудия «ТВ-Центр»</h3>
                <p className="text-gray-600 mb-4">
                  Оборудование гримерных зон и комнат отдыха для съемок популярного телешоу
                </p>
                <div className="flex items-center text-sm text-gray-500">
                  <Icon name="MapPin" className="h-4 w-4 mr-1" />
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden group">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-2">Рекламная кампания «Luxury»</h3>
                <p className="text-gray-600 mb-4">
                  Комплексное оборудование площадки для съемок рекламы премиального бренда
                </p>
                <div className="flex items-center text-sm text-gray-500">
                  <Icon name="MapPin" className="h-4 w-4 mr-1" />

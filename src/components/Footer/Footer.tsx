        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Профессиональная аренда гримерок и мебели для съемок шоу, фильмов
              и фотосессий. Мы помогаем создать идеальные условия для работы
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start">
                <Icon
                  ...
                  className="h-5 w-5 text-gray-500 mr-3 mt-0.5"
                />
                <span className="text-gray-600">+7 (968) 830-88-55</span>
              </div>
              <div className="flex items-start">
                <Icon
                  name="Mail"
                  className="h-5 w-5 text-gray-500 mr-3 mt-0.5"
                />
                <span className="text-gray-600">1223pleer@gmail.com</span>
              </div>
              <div className="flex items-start">
                <Icon
                  name="Clock"
